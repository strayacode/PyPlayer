...
data = {
	"AUDIO_DIR": "",
	"CODE_DIR" : "D:\Documents\Code\PyPlayer-master"
}
...
if os.path.getsize("D:\Documents\Code\PyPlayer-master/data.json") == 0:
...
def get_thumbnail(file):
	...
	# with open("image.jpg", "wb+") as img:
		# img.write(album_art)
	# thumb = Image.open("{}/image.jpg".format(data["AUDIO_DIR"]))
	# resize = thumb.resize((45, 45), Image.ANTIALIAS)
	# resize.save("{}/image.jpg".format(data["AUDIO_DIR"]))
...
# image = Image.open("{}/image.jpg".format(data["AUDIO_DIR"]))
